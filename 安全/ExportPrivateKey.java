...
public class ExportPrivateKey {
    ...
    public static void main(String args[]) throws Exception{
        ...
        export.keystoreFile=new File("/Users/huhl/Projects/allStack/spring-cloud/authserver/src/main/resources/keystore.jks");
        export.keyStoreType="JKS";
        export.password="foobar".toCharArray();
        export.alias="test";
        export.exportedFilePrivate=new File("privateKey.PEM");
        export.exportedFilePublic=new File("publicKey.PEM");
        export.export();
        //export.testvaliate();
    }
